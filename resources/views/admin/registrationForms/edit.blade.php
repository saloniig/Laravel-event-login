                ...
                <div class="panel-body">
                    <form method="POST" action="{{ route("admin.registration-forms.update", [$registrationForm->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group {{ $errors->has('first_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="first_name" id="first_name" value="{{ old('first_name', $registrationForm->first_name) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('last_name') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="last_name" id="last_name" value="{{ old('last_name', $registrationForm->last_name) }}">
                        ...
                        <div class="form-group {{ $errors->has('university_roll_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="university_roll_number" id="university_roll_number" value="{{ old('university_roll_number', $registrationForm->university_roll_number) }}">
                        ...
                        <div class="form-group {{ $errors->has('class_roll_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="class_roll_number" id="class_roll_number" value="{{ old('class_roll_number', $registrationForm->class_roll_number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="email" id="email" value="{{ old('email', $registrationForm->email) }}" required>
                            @if($errors->has('email'))
                        ...
                        <div class="form-group {{ $errors->has('phone_number') ? 'has-error' : '' }}">
                            ...
                            <input class="form-control" type="text" name="phone_number" id="phone_number" value="{{ old('phone_number', $registrationForm->phone_number) }}" required>
                        ...
                        <div class="form-group {{ $errors->has('branch') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="branch" id="branch" required>
                                ...
                                @foreach(App\RegistrationForm::BRANCH_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('branch', $registrationForm->branch) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group {{ $errors->has('year') ? 'has-error' : '' }}">
                            ...
                            <select class="form-control" name="year" id="year" required>
                                ...
                                @foreach(App\RegistrationForm::YEAR_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('year', $registrationForm->year) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                            @if($errors->has('year'))
                        ...
                        <div class="form-group {{ $errors->has('iste_member') ? 'has-error' : '' }}">
                            ...
                            @foreach(App\RegistrationForm::ISTE_MEMBER_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="iste_member_{{ $key }}" name="iste_member" value="{{ $key }}" {{ old('iste_member', $registrationForm->iste_member) === (string) $key ? 'checked' : '' }} required>
